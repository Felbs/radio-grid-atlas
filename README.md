...
| [flex-pager](flex-pager/) | FLEX paging (929 MHz) | 1.875 s frame comb (240 s / 128), 4-FSK at ±1600/±4800 Hz, 3200 sym/s | ✅ measured — went in hunting POCSAG, the band said FLEX; PM addendum: comb nailed to GPS time (45/45 decoded frame numbers, 0.03 ms rms; the network never subtracted a leap second) |
| [gps-l1-ca](gps-l1-ca/) | GPS L1 C/A | 1023-chip Gold codes @ 1.023 Mchip/s (1 ms epochs), 50 bps nav bits, code/carrier locked 1:1540 | ✅ measured — 4 SVs below the noise floor on rabbit ears; PM addendum: nav message decoded, 180/180 words parity-clean, GPS time read off the air |
